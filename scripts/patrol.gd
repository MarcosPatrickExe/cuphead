...
func tick(actor, blackboard):
	...
	var distance_to_target = actor.enemyBody.get_global_position() - actor.get_child(0).get_global_position();       #get_viewport().get_mouse_position() - actor.get_child(0).get_global_position();
